...
#$(awk "BEGIN {printf \"%.3f\",0.5+(${RANDOM}%1000)/1000}")

echo "This job is running on $HOSTNAME on `date`"

./phylo_spatial_trait sample num_samples=15000 num_warmup=5000 thin=5 data file=./trait_data_list.R init=0.5 output file=./stan_output${PBS_ARRAYID}.csv
