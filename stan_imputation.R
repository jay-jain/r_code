...
#n't help with convergence, we will have to change the prior specifications inside the model.
# If that STILL does If that still doesn't work, we will have to change the actual parameterization of the model (let's hope that isn't necessary).
